...
# A mapping of all types accepted/required
# by the API to their Python equivalents.
APITypes = {'bool':      bool,
            'int32':     int,
            'uint32':    int,
            'uint64':    int,
...
if sys.version_info.major < 3:
    # Starting with Python 3, "str" means unicode and "unicode" is not defined.
    # It is still relevant for Python 2.x, however.
...
class APICall(object):
    ...
    def _api_key(self):
        ...
        If a key is defined in this call's APIInterface "grandparent"
        (since each APICall has a APICall parent), it is used and cached by
        this object indefinitely. (Until destruction)
            ...
            try:
                ...
                if IPYTHON_MODE is True:
                    ...
                    if item == "getdoc":
                        ...
                        # IPython always looks for this, no matter what
                        # (hiding it in __dir__ doesn't work), so this is
    ...
    def _set_documentation(self, docstring):
        """
        Set a docstring specific to this instance of APICall, explaining
        the bound function.
    ...
    def _register(self, apicall_child=None):
        """
        Register a child APICall object under the "self._resolved_children"
        dictionary so it can be used normally. Used by API function wrappers
        after they're deemed working.
    ...
    def _convert_arguments(self, kwargs):
        """
        Convert the types of given arguments to a call-friendly format.
        Modifies the given dictionary directly.
...
class APIInterface(object):
    ...
    def __init__(self, api_key=None, autopopulate=False, strict=False,
        ...
        """
        Initialize a new APIInterface object. This object defines an
        API-interacting session, and is used to call any API functions from
        standard code.
            ...
            for method in interface.methods:
                ...
                for parameter in method.parameters:
                    ...
                    if 'description' in parameter:
                        ...
                        desc = "(no description)"
                    parameters += [parameter_description.format(
